 ...
 */
public class BiCubicInterpolator3D extends Interpolator3DBase {
    private BiCubicInterpolator interpolator=null;
    private Weight3D[][][] weight3Ds = null;
    
    int srcLevs = 0; 
    
    public BiCubicInterpolator3D(double[][] srcLAT, double[][] srcLON, double[][][] srcZ, double[][] dstLAT, double[][] dstLON, double[][][] dstZ, int[][] srcMASK, int[][] dstMASK) throws InterpolatorException {
        interpolator = new BiCubicInterpolator(srcLAT, srcLON, dstLAT, dstLON, srcMASK, dstMASK);
