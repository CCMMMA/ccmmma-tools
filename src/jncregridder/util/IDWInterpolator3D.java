...
public class IDWInterpolator3D extends Interpolator3DBase {
    private IDWInterpolator interpolator=null;
    private Weight3D[][][] weight3Ds = null;

    int srcLevs = 0;

    public IDWInterpolator3D(double[][] srcLAT, double[][] srcLON, double[][][] srcZ, double[][] dstLAT, double[][] dstLON, double[][][] dstZ, int[][] srcMASK, int[][] dstMASK) throws InterpolatorException {
        interpolator = new IDWInterpolator(srcLAT, srcLON, dstLAT, dstLON, srcMASK, dstMASK);
